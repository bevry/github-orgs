...
``` typescript
import pkg from 'https://unpkg.com/@bevry/github-orgs@^3.0.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/@bevry/github-orgs@^3.0.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/@bevry/github-orgs@^3.0.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/@bevry/github-orgs@3.0.0'
</script>
```
